...
xrayvless1="vless://${uuid}@${domain}:$tls?path=/NYARIGRATISAN&security=tls&encryption=none&type=ws#${user}"
xrayvless2="vless://${uuid}@${domain}:$nontls?path=/NYARIGRATISAN&encryption=none&type=ws#${user}"
