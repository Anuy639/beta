...
clear
# Link Hosting Kalian
bzvpn="raw.githubusercontent.com/anuy639/beta/bz/ssr"
...
Start_SSR(){
	check_pid
	wget -O /etc/init.d/ssrmu "https://${bzvpn}/ssrmu"
...
Install_SSR
wget -O /usr/bin/ssr https://${bzvpn}/ssrmu.sh && chmod +x /usr/bin/ssr
wget -O /usr/bin/addssr https://${bzvpn}/addssr.sh && chmod +x /usr/bin/addssr
wget -O /usr/bin/delssr https://${bzvpn}/delssr.sh && chmod +x /usr/bin/delssr
wget -O /usr/bin/renewssr https://${bzvpn}/renewssr.sh && chmod +x /usr/bin/renewssr
