#!/bin/bash
#shadowsocks-libev obfs install by AnuyaBazoelk
...
clear
# Link Hosting Kalian
bzvpn="raw.githubusercontent.com/anuy639/beta/bz/shadowsocks"
...
cd /usr/bin
wget -O addss "https://${bzvpn}/addss.sh"
wget -O delss "https://${bzvpn}/delss.sh"
wget -O cekss "https://${bzvpn}/cekss.sh"
wget -O renewss "https://${bzvpn}/renewss.sh"
chmod +x addss
chmod +x delss
chmod +x cekss
chmod +x renewss
