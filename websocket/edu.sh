...
clear
# Link Hosting Kalian
bzvpn="raw.githubusercontent.com/anuy639/beta/bz/websocket"

# Getting Proxy Template
wget -q -O /usr/local/bin/ws-nontls https://${bzvpn}/websocket.py
...
# Getting Proxy Template
wget -q -O /usr/local/bin/ws-ovpn https://${bzvpn}/ws-ovpn.py
