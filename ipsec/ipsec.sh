...
# ==================================================
# Link Hosting Kalian
bzvpn="raw.githubusercontent.com/anuy639/beta/bz/ipsec"
...
wget -O /usr/bin/addl2tp https://${bzvpn}/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp https://${bzvpn}/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/addpptp https://${bzvpn}/addpptp.sh && chmod +x /usr/bin/addpptp
